  ...
  return (
    <Section crosses>
      <div className="container md:flex justify-center items-center ">
        ...
        <div className="lg:ml-5 xl:w-[38rem]">
          <p className="mt-4 body-2 mb-4 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto ">
            {collabText}
          </p>
          ...
          <div className="mt-4 relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100">
            <div className="flex w-60 aspect-square m-auto rounded-full border border-n-6">
              <div className="flex w-[6rem] aspect-square m-auto rounded-full border border-n-6 p-[0.2rem] bg-conic-gradient">
